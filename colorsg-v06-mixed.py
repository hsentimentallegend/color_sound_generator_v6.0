...
if img_file is not None:
    ...
    third = h // 3
    part1 = img_array[:third, :, :]  # Top
    part2 = img_array[third:2*third, :, :]  # Middle
    part3 = img_array[2*third:, :, :]  # Bottom
    ...
    if mode == "Random Mode":
        ...
        if avg_v >= 0.5:
            chord_freqs = [
                root_freq,                  # Root
                root_freq * (2 ** (4 / 12)),  # Major 3rd
                root_freq * (2 ** (7 / 12)),  # Perfect 5th
                root_freq * (2 ** (11 / 12)), # Major 7th
                root_freq * (2 ** (14 / 12))  # Major 9th
            ]
            mode_display = "Harmony Mode (Major 9th)"
        else:
            chord_freqs = [
                root_freq,                  # Root
                root_freq * (2 ** (3 / 12)),  # Minor 3rd
                root_freq * (2 ** (7 / 12)),  # Perfect 5th
                root_freq * (2 ** (10 / 12)), # Minor 7th
                root_freq * (2 ** (14 / 12))  # Major 9th
            ]
